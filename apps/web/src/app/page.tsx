    ...
    <div className="space-y-16">
      ...
      <section className="mx-auto max-w-4xl overflow-hidden rounded-xl border border-line bg-white">
        ...
        <div className="grid grid-cols-1 divide-line sm:grid-cols-3 sm:divide-x sm:divide-x-reverse">
          {[
            { k: "نراقب", t: "نرصد عطاءات GTD وJONEPS على مدار الساعة من مصادرها الرسمية." },
            { k: "نطابق", t: "نطابق كل عطاء مع تصنيف شركتك ومجال عملك وكلماتك المفتاحية — بنسبة وسبب واضح." },
            { k: "نوصّل", t: "إيميل صباحي واحد بالعطاءات التي تخصّك فقط، مع رابط المصدر الرسمي." },
          ].map((s) => (
